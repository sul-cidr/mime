...
@plot-poses path:
  ...
  docker compose exec web-extras sh -c "pixplot --images \"input/$1/pose_images/*.jpg\" --vectors input/$1/pose_features --metadata input/$1/JuliusCaesar—WinterMainStage23.mp4.csv"
