...
async def get_nearest_hands(
    ...
    return await self._pool.fetch(
        ...
        WITH hand_results AS(
            WITH search_results AS(
                SELECT hand.video_id, video.video_name, hand.frame, hand.pose_idx, hand.is_right, pose.norm, pose.keypoints, hand.keypoints2d, hand.is_right AS search_is_right, {distance} AS distance, frame.shot AS shot FROM hand, pose, frame, video
